...
from dl_project.artifacts_mgr.artifact_generator import ConfiguartionManager
...
from dl_project.artifacts_mgr.artifact_config import TIMESTAMP
...
class DataIngestionPipeline:
    def __init__(self):
        self.config = ConfiguartionManager(DataIngestionConfig, DataIngestionArtifacts)
